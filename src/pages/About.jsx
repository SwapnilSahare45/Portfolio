...
const About = () => {
    return (
        <div id="about" className="min-h-screen flex flex-col items-center justify-center gap-4 ">

            <h1 className="font-orbitron uppercase tracking-wider text-4xl font-semibold md:text-6xl z-2">About me</h1>

            <p className="font-gruppo text-xl text-center tracking-wide px-4 md:px-24 lg:text-2xl lg:px-60 z-2">
